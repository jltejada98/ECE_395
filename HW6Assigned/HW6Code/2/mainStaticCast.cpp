...
int main() {
    ...
    // Not allowed due to no relation between Student and Faculty by inheritance
    Student* s = static_cast<Student*>(f);
    ...
    // Allowed due ISA relation between Person and Student
